...
class GovernmentsAdapter(context: Context) : BaseAdapter() {

    var layoutInflater: LayoutInflater = LayoutInflater.from(context)

    var dataList: MutableList<GovernmentItem> = mutableListOf()

    fun setData(dataList: MutableList<GovernmentItem>?) {
        if (dataList != null) {
    ...
    override fun getItem(position: Int): GovernmentItem {
